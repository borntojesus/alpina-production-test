...
if( jQuery('body').find('.parallax-homepage').length>0 ) {
    var fixclass = jQuery( '.mukam-waypoint2' ).data( 'animateUp' ),
        loaded = ' mukam-header2 ' + fixclass;jQuery('#mukam_header').attr('id','mukam_header2').removeAttr('mukam_header');
    jQuery('#mukam_header2').attr( 'class' , loaded);// Parallax Fix
    //-------------
...
jQuery(document).ready(function() {"use strict";jQuery( ".search-widget .social-box" ).click(function() {
  ...
  // WoocommerceQuantiy
    jQuery( document ).on( 'click', '.plus, .minus', function($) {"use strict";// Get values
    ...
    if ( jQuery( this ).is( '.plus' ) ) {if ( max && ( max == currentVal || currentVal > max ) ) {
        qty.val( max );
      } else {
...
jQuery(function(jQuery) {"use strict";
 ...
 // Filter for Portfolio
    jQuery('.latest-word-grid-container .menu-widget a').click(function(e){
        ...
        container.find('.latest-work-item:not(.'+category+')').addClass('hidden');container.masonry({
        isAnimated: true,
        itemSelector:'.latest-work-item:not(.hidden)',
        columnWidth: '.grid-sizer',
        });container.masonry();
...
jQuery(function(jQuery) {"use strict";
 ...
 // Filter for Portfolio
    jQuery('.portfolio-style-1-filter a').click(function(e){
        ...
        container.find('.portfolio-item:not(.'+category+')').addClass('hidden');container.masonry({
        isAnimated: true,
        itemSelector:'.portfolio-item:not(.hidden)',
        columnWidth: '.grid-sizer',
        });container.masonry();
...
jQuery(function(jQuery) {"use strict";
 ...
 // Filter for Portfolio
    jQuery('.portfolio-style-1-filter a').click(function(e){
        ...
        container.find('.portfolio-item-2:not(.'+category+')').addClass('hidden');container.masonry({
        isAnimated: true,
        itemSelector:'.portfolio-item-2:not(.hidden)',
        columnWidth: '.grid-sizer',
        });container.masonry();
...
jQuery(function(jQuery) {"use strict";
 ...
 // Filter for Portfolio
    jQuery('.portfolio-style-1-filter a').click(function(e){
        ...
        container.find('.portfolio-item-3:not(.'+category+')').addClass('hidden');container.masonry({
        isAnimated: true,
        itemSelector:'.portfolio-item-3:not(.hidden)',
        columnWidth: '.grid-sizer',
        });container.masonry();
